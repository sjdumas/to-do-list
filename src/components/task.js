...
export function task(data) {
  ...
  const closeCreateTaskGeneral = (event) => {
    ...
    cancelGeneralButton.removeEventListener("click", closeCreateTaskGeneral);
  ...
  const displayCreateTaskGeneral = () => {
    const generalTaskDialog = document.querySelector(".general-task");
    const addTaskGeneralButton = document.querySelector(".add-task-general");
    const cancelGeneralButton = document.querySelector(
      ".cancel-general-button"
    );
    ...
    addTaskGeneralButton.addEventListener("click", () => {
      ...
      generalTaskForm.addEventListener("submit", (event) => {
        event.preventDefault();
        const generalTaskName = document.querySelector(".general-task-name");
        ...
        const generalTaskDate = document.querySelector(".general-task-date");
      ...
      cancelGeneralButton.addEventListener("click", closeCreateTaskGeneral);
    });
  };
